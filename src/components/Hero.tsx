  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center text-center p-8 relative overflow-hidden">
      ...
      <Link
        href="#about"
        scroll={true}
        className="mt-6 inline-block px-6 py-3 rounded-full border border-cyan-400 text-cyan-600 dark:text-cyan-300 hover:bg-cyan-100 dark:hover:bg-cyan-400/10 transition-all duration-300 font-semibold shadow-sm"
      >
        View Portfolio
      </Link>
    </section>
